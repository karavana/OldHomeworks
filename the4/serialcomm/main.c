...
void Init(void)
{
	...
	TXSTA1 = 0x04;  //0x24 to enable transmit // (= 00000100) 8-bit transmit, transmitter NOT enabled, asynchronous,
						// high speed mode
	RCSTA1 = 0x90;                   // (= 10010000) 8-bit receiver, receiver enabled, continuous receive,
                                                // serial port enabled
